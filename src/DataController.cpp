...
DataController::DataController(string configFilePath) {
    ...
    _appModel->setProperty("scenesDataPath", (string)"E:/gameoverload/VideoProjects/Jungle/finalALL/video");
    _appModel->setProperty("flashDataPath", (string)"E:/gameoverload/VideoProjects/Jungle/finalALL/flash");
    _appModel->setProperty("audioDataPath", (string)"E:/gameoverload/VideoProjects/Jungle/finalALL/audio");
