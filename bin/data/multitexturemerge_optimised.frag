...
void main(){
	...
	texCoord = gl_TexCoord[0].xy; // This _might_ be faster...
	sceneTexel	= texture2DRect(textures[0], texCoord);
	vic1Texel	= texture2DRect(textures[1], texCoord);
	atk1Texel	= texture2DRect(textures[2], texCoord);
